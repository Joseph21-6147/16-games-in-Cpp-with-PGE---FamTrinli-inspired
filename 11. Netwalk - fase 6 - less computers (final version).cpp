...
public:
    ...
    // Have to check out Prim's algorithm for minimal spanning tree. The following
    ...
    void generatePuzzle() {
        ...
        while (!nodes.empty()) {
            ...
            // this is to reduce the number of computers in the network
    ...
    bool OnUserUpdate( float fElapsedTime ) override {
        ...
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < N; j++) {
                ...
                // the constant is a speed factor on the rotation speed of the animation
                p.angle += 500.0f * fElapsedTime;
